 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class questionvote_updated extends \core\event\base {
    /**
     * Init method.
     *
     * @return void
    ...
    protected function init() {
        ...
        $this->data['objecttable'] = 'forumqta_uservotes';
    }
    ...
    public function get_description() {
        return "The user with id '$this->userid' has updated the vote for the question with id '$this->objectid' in the forumqta with course module id '$this->contextinstanceid'.";
    }
    ...
    public static function get_name() {
        return get_string('eventquestionvoteupdated', 'mod_forumqta');
    }
    ...
    protected function get_legacy_logdata() {
        ...
        return array($this->courseid, 'forumqta', 'update question vote', $logurl, $this->contextinstanceid);
    }
