 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class answer_selected extends \core\event\base {
    /**
     * Init method.
     *
     * @return void
    ...
    public function get_description() {
        return "The user with id '$this->userid' has selected the best answer for the question with id '$this->objectid' in the forumqta with course module id '$this->contextinstanceid'.";
    }
    ...
    public static function get_name() {
        return get_string('eventanswerselected', 'mod_forumqta');
    }
    ...
    protected function get_legacy_logdata() {
        ...
        return array($this->courseid, 'forumqta', 'select answer', $logurl, $this->contextinstanceid);
    }
