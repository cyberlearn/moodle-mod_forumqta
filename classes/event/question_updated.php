...
class question_updated extends \core\event\base {
    ...
    public function get_description() {
        return "The user with id '$this->userid' has updated the question with id '$this->objectid' in the forumqta with course module id '$this->contextinstanceid'.";
    }
    ...
    public static function get_name() {
        return get_string('eventquestionupdated', 'mod_forumqta');
    }
    ...
    protected function get_legacy_logdata() {
        ...
        return array($this->courseid, 'forumqta', 'update question', $logurl, $this->contextinstanceid);
    }
