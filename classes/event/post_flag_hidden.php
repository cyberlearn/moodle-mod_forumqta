 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class post_flag_hidden extends \core\event\base {
    /**
     * Init method.
     *
     * @return void
    ...
    public function get_description() {
        return "The post with id '$this->objectid' in the forumqta with course module id '$this->contextinstanceid'. has been hidden due to flags";
    }
    ...
    public static function get_name() {
        return get_string('eventpostflaghidden', 'mod_forumqta');
    }
    ...
    protected function get_legacy_logdata() {
        ...
        return array($this->courseid, 'forumqta', 'hide post due to flags', $logurl, $this->contextinstanceid);
    }
