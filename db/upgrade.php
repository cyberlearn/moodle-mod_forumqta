...
/**
 * This file keeps track of upgrades to the forumqta module
 *
...
/**
 * Execute forumqta upgrade from the given old version
 *
 * @param int $oldversion
 * @return bool
 */
function xmldb_forumqta_upgrade($oldversion) {
    global $DB;
    ...
    // for demonstrative purposes and to show how the forumqta
    // iself has been upgraded.

    // For each upgrade block, the file forumqta/version.php
    ...
    if ($oldversion < 2007040100) {
        ...
        // Define field course to be added to forumqta
        ...
        // Define field intro to be added to forumqta
        $table = new xmldb_table('forumqta');
        ...
        // Define field introformat to be added to forumqta
        $table = new xmldb_table('forumqta');
        ...
        upgrade_mod_savepoint(true, 2007040100, 'forumqta');
    }
    ...
    if ($oldversion < 2007040101) {
        ...
        // Define field timecreated to be added to forumqta
        $table = new xmldb_table('forumqta');
        ...
        // Define field timemodified to be added to forumqta
        $table = new xmldb_table('forumqta');
        ...
        // Define index course (not unique) to be added to forumqta
        $table = new xmldb_table('forumqta');
        ...
        upgrade_mod_savepoint(true, 2007040101, 'forumqta');
    }
