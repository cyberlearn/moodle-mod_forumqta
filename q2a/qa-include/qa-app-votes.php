...
*/
	{
        ...
        if ($post['basetype']=='Q') {
            $event = \mod_forumqta\event\questionvote_updated::create($params);
            $event->trigger();
        }
        else {
            $event = \mod_forumqta\event\answervote_updated::create($params);
            $event->trigger();
        }
...
*/
	{
        ...
        $params = array(
            'context' => $context,
            'objectid' => $oldpost['postid'],
        );
        $event = \mod_forumqta\event\post_flagged::create($params);
        $event->trigger();
...
*/
	{
        ...
        $event = \mod_forumqta\event\post_unflagged::create($params);
        $event->trigger();
	}
