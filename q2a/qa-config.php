...
require_once(dirname(dirname(dirname(dirname(__FILE__)))).'/config.php');
	...
	//Define here information relatived to your SMTP server
define('SMTP_HOST', 'mail.infomaniak.com');
define('SMTP_PORT', 587);
define('SMTP_USENAME', 'no-reply@cyberlearn-mobile-dev.ch');
define('SMTP_PASSWORD', 'yourpasswordhere');
...
*/
	define('QA_MYSQL_TABLE_PREFIX', $CFG->prefix.'forumqta_');
